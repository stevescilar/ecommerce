    ...
    <div class="content">
    	...
    	<div class="psuccess">
            ...
            if ($amount) {
             ...
             ?>
            <p>Total Payable Amount(Including VAT):SH. 
                <?php 
                $vat = $sum*0.1;
                $total = $sum+$vat;
                echo $total;
            ...
            <p>Thanks for Purchase.Receive your order Successfully. We will contact you soon with delivery details. Here is your order details....<a href="orderdetails.php">Click Here...</a></p>
    	</div>
